...
import { CheckCircle, BookOpen, Users, Clock, Award, Search, Play } from 'lucide-react'
...
export default function EthicalHackingCourse() {
 ...
 useEffect(() => {
   ...
   const completedVideos = mockSections.reduce((sum, section) => sum + section.videos.filter(v => v.completed).length, 0)
         ...
         <Tabs defaultValue="overview" className="mb-8">
           ...
           <TabsContent value="overview">
             <Card>
               ...
               <CardContent>
                 <p className="mb-4">This comprehensive ethical hacking course takes you from a beginner to an advanced level, covering all aspects of cybersecurity and ethical hacking. You'll learn through hands-on projects, real-world scenarios, and in-depth lectures.</p>
           ...
           <TabsContent value="instructor">
             <Card>
               ...
               <CardContent>
                 ...
                 <p className="mb-4">John Doe is a renowned cybersecurity expert with over 15 years of experience in the field. He has worked with Fortune 500 companies and government agencies to secure their digital assets and train their security teams.</p>
         ...
         <Card className="sticky top-8">
           ...
           <CardContent>
             ...
             {user ? (
               ...
               <Button disabled className="w-full mb-4">Please log in to enroll</Button>
             )}
             <ul className="space-y-2">
